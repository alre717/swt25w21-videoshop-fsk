...
public class Disc extends Product {
	...
	public Disc(String name, String image, Money price, String genre, DiscType type, int fsk) {
	...
	// Weil wir keine Liste zurückgeben, verhindern wir auch, dass jemand die comments-Liste
