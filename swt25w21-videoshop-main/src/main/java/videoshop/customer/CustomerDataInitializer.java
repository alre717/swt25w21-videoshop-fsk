...
class CustomerDataInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		List.of(
				new RegistrationForm("hans", password, "wurst", LocalDate.of(1990, 8, 14)),
				new RegistrationForm("dextermorgan", password, "Miami-Dade County", LocalDate.of(2020, 1, 1)),
				new RegistrationForm("earlhickey", password, "Camden County - Motel", LocalDate.of(2025, 12, 30)),
				new RegistrationForm("mclovinfogell", password, "Los Angeles", LocalDate.of(2000, 8, 14))
