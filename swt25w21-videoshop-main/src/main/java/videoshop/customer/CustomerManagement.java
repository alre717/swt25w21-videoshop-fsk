...
public class CustomerManagement {
	...
	public Customer createCustomer(RegistrationForm form) {
		...
		return customers.save(new Customer(userAccount, form.getAddress(), form.getBirthDate()));
	...
	public Optional<Customer> findByUserAccount(UserAccount account) {
		return customers.findByUserAccount(account);
	}
}
